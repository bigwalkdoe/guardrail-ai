...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_guardrail_logs_id"), "guardrail_logs", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_guardrail_logs_user_id"), "guardrail_logs", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_guardrail_logs_prompt_hash"),
        "guardrail_logs",
        ["prompt_hash"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_guardrail_rules_id"), "guardrail_rules", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_user_mfa_settings_id"), "user_mfa_settings", ["id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "exposure_level", sa.String(20), server_default="internal", nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_assets_ip_address"), "assets", ["ip_address"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "exploit_probability", sa.Float(), server_default="0.0", nullable=False
        ),
        sa.Column("risk_score", sa.Float(), server_default="0.0", nullable=False),
        sa.Column(
            "is_exploitable", sa.Boolean(), server_default="false", nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_vulnerabilities_cve_id"), "vulnerabilities", ["cve_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_threat_intel_indicator_value"),
        "threat_intel",
        ["indicator_value"],
        unique=False,
    )
